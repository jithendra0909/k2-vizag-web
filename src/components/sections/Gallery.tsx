            ...
            {filteredItems.map((item) => {
              return (
                <motion.div
                  ...
                  className="break-inside-avoid relative overflow-hidden rounded-2xl border border-[#F5E000]/20 hover:border-[#F5E000] bg-[#000000] group transition-colors duration-300"
                >
                  {/* Image Graphic */}
                  ...
                  {/* Hover Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-[#000000] via-[#000000]/60 to-transparent opacity-0 group-hover:opacity-90 transition-opacity duration-300 flex flex-col justify-end p-6 z-10">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#FFFFFF] bg-[#25D366] hover:opacity-95 px-4 py-2 rounded-md transition-all w-fit"
                    >
